...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->kemParameterSpec:Lorg/bouncycastle/jcajce/spec/KEMParameterSpec;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    :goto_0
    iget-object p4, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->random:Ljava/security/SecureRandom;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->random:Ljava/security/SecureRandom;
    ...
    :goto_0
    iput-object p3, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->kemParameterSpec:Lorg/bouncycastle/jcajce/spec/KEMParameterSpec;
    ...
    invoke-direct {p1, p4}, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMGenerator;-><init>(Ljava/security/SecureRandom;)V
...
.method protected engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    :try_start_0
    new-instance p3, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMExtractor;

    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->unwrapKey:Lorg/bouncycastle/pqc/jcajce/provider/ntru/BCNTRUPrivateKey;

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/jcajce/provider/ntru/BCNTRUPrivateKey;->getKeyParams()Lorg/bouncycastle/pqc/crypto/ntru/NTRUPrivateKeyParameters;

    move-result-object v1

    invoke-direct {p3, v1}, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMExtractor;-><init>(Lorg/bouncycastle/pqc/crypto/ntru/NTRUPrivateKeyParameters;)V

    invoke-virtual {p3}, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMExtractor;->getEncapsulationLength()I
    ...
    invoke-virtual {p3, v1}, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMExtractor;->extractSecret([B)[B

    move-result-object v1

    iget-object v3, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->kemParameterSpec:Lorg/bouncycastle/jcajce/spec/KEMParameterSpec;
...
.method protected engineWrap(Ljava/security/Key;)[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/ntru/NTRUCipherSpi;->wrapKey:Lorg/bouncycastle/pqc/jcajce/provider/ntru/BCNTRUPublicKey;

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/jcajce/provider/ntru/BCNTRUPublicKey;->getKeyParams()Lorg/bouncycastle/pqc/crypto/ntru/NTRUPublicKeyParameters;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMGenerator;->generateEncapsulated(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/SecretWithEncapsulation;
