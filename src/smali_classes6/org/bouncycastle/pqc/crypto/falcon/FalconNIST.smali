...
.method crypto_sign([B[BII[BI)[B
    ...
    new-instance v4, Lorg/bouncycastle/pqc/crypto/falcon/SHAKE256;

    invoke-direct {v4}, Lorg/bouncycastle/pqc/crypto/falcon/SHAKE256;-><init>()V
    ...
    new-instance v3, Lorg/bouncycastle/pqc/crypto/falcon/FalconCommon;

    invoke-direct {v3}, Lorg/bouncycastle/pqc/crypto/falcon/FalconCommon;-><init>()V
    ...
    invoke-virtual/range {v3 .. v14}, Lorg/bouncycastle/pqc/crypto/falcon/FalconVrfy;->complete_private([BI[BI[BI[BII[SI)I
    ...
    invoke-virtual/range {v24 .. v24}, Lorg/bouncycastle/pqc/crypto/falcon/SHAKE256;->inner_shake256_init()V
    ...
    invoke-static {v5, v11, v1, v2, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v4, v0, Lorg/bouncycastle/pqc/crypto/falcon/FalconNIST;->NONCELEN:I

    add-int/2addr v4, v2

    invoke-static {v10, v11, v1, v4, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v1, v11, v4}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
...
.method crypto_sign_keypair([BI[BI)[[B
    ...
    invoke-static {v1, v2, v7}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-static {v8, v11, v2}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
...
.method crypto_sign_open([B[B[B[BI)I
    .locals 19
    ...
    :cond_2
    invoke-virtual/range {p4 .. p4}, Lorg/bouncycastle/pqc/crypto/falcon/SHAKE256;->inner_shake256_init()V
