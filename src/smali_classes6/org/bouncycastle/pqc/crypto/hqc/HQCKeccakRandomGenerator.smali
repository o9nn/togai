.class Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakRoundConstants:[J
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J

    const/16 v0, 0xc0

    new-array v0, v0, [B

    iput-object v0, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->dataQueue:[B

    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->init(I)V
...
.method private KeccakIncAbsorb([BI)V
    ...
    :cond_0
    iget v1, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->rate:I
    ...
    iget-object v7, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
    ...
    invoke-direct {v0, v7}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakPermutation([J)V
    ...
    iget-object v4, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
    ...
    :cond_3
    iget-object v1, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
...
.method private KeccakIncFinalize(I)V
    ...
    iget v0, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->rate:I

    shr-int/lit8 v0, v0, 0x3

    iget-object v1, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
...
.method private KeccakIncSqueeze([BI)V
    ...
    iget v2, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->rate:I
    ...
    iget-object v9, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
    ...
    iget-object v3, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
    ...
    invoke-direct {v0, v3}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakPermutation([J)V
    ...
    iget-object v8, v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
...
.method private KeccakPermutation([J)V
    .locals 93
    ...
    sget-object v5, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakRoundConstants:[J
...
.method private init(I)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->initSponge(I)V
...
.method private initSponge(I)V
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->rate:I
    ...
    :goto_0
    iget-object v3, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->state:[J
    ...
    :cond_0
    iget-object v2, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->dataQueue:[B

    invoke-static {v2, v1}, Lorg/bouncycastle/util/Arrays;->fill([BB)V

    iput v1, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->bitsInQueue:I

    iput-boolean v1, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->squeezing:Z

    sub-int/2addr v0, p1

    div-int/lit8 v0, v0, 0x2

    iput v0, p0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->fixedOutputLength:I
...
.method public SHAKE256_512_ds([B[BI[B)V
    ...
    :cond_0
    invoke-direct {p0, p2, p3}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V

    array-length p2, p4

    invoke-direct {p0, p4, p2}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V

    const/16 p2, 0x1f

    invoke-direct {p0, p2}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncFinalize(I)V

    const/16 p2, 0x40

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncSqueeze([BI)V
...
.method public expandSeed([BI)V
    ...
    invoke-direct {p0, v2, v1}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncSqueeze([BI)V
...
.method public randomGeneratorInit([B[BII)V
    ...
    invoke-direct {p0, p1, p3}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V

    invoke-direct {p0, p2, p4}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V

    invoke-direct {p0, v1, v0}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V

    const/16 p1, 0x1f

    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncFinalize(I)V
...
.method public seedExpanderInit([BI)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeccakRandomGenerator;->KeccakIncAbsorb([BI)V
