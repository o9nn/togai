...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;,
        Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridEntropySource;,
        Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySource;,
        Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySourceProvider;,
...
.field private static entropyDaemon:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->entropyDaemon:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;

    sput-object v0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->entropyThread:Ljava/lang/Thread;

    new-instance v1, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;-><init>(Lorg/bouncycastle/jcajce/provider/drbg/DRBG$1;)V

    sput-object v1, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->entropyDaemon:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;

    new-instance v0, Ljava/lang/Thread;

    sget-object v1, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->entropyDaemon:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;
...
.method static synthetic access$1000()J
    ...
    invoke-static {}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->getPause()J
...
.method static synthetic access$200(Z)Ljava/security/SecureRandom;
    .locals 0
...
.method static synthetic access$300()Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;
    .locals 1

    sget-object v0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG;->entropyDaemon:Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;
...
.method static synthetic access$800()Lorg/bouncycastle/crypto/prng/EntropySourceProvider;
    .locals 1
...
.method private static createBaseRandom(Z)Ljava/security/SecureRandom;
    ...
    invoke-direct {v0, v1, v2}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$HybridEntropySource;-><init>(Lorg/bouncycastle/jcajce/provider/drbg/DRBG$EntropyDaemon;I)V
...
.method private static createEntropySource()Lorg/bouncycastle/crypto/prng/EntropySourceProvider;
    ...
    new-instance v1, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$4;

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$4;-><init>(Ljava/lang/String;)V
...
.method private static createInitialEntropySource()Lorg/bouncycastle/crypto/prng/EntropySourceProvider;
    ...
    new-instance v2, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySourceProvider;

    invoke-direct {v2, v0, v1}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySourceProvider;-><init>(Ljava/security/SecureRandom;Z)V

    return-object v2

    :cond_0
    new-instance v0, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySourceProvider;
    ...
    invoke-direct {v0, v2, v1}, Lorg/bouncycastle/jcajce/provider/drbg/DRBG$IncrementalEntropySourceProvider;-><init>(Ljava/security/SecureRandom;Z)V
