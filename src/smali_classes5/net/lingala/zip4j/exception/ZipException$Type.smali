...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V
    ...
    .line 56
    new-instance v2, Lnet/lingala/zip4j/exception/ZipException$Type;

    const-string v3, "CHECKSUM_MISMATCH"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lnet/lingala/zip4j/exception/ZipException$Type;->CHECKSUM_MISMATCH:Lnet/lingala/zip4j/exception/ZipException$Type;
    ...
    invoke-direct {v3, v4, v5}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lnet/lingala/zip4j/exception/ZipException$Type;->UNKNOWN_COMPRESSION_METHOD:Lnet/lingala/zip4j/exception/ZipException$Type;

    .line 58
    new-instance v4, Lnet/lingala/zip4j/exception/ZipException$Type;

    const-string v5, "FILE_NOT_FOUND"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lnet/lingala/zip4j/exception/ZipException$Type;->FILE_NOT_FOUND:Lnet/lingala/zip4j/exception/ZipException$Type;
    ...
    invoke-direct {v5, v6, v7}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lnet/lingala/zip4j/exception/ZipException$Type;->UNSUPPORTED_ENCRYPTION:Lnet/lingala/zip4j/exception/ZipException$Type;

    .line 60
    new-instance v6, Lnet/lingala/zip4j/exception/ZipException$Type;

    const-string v7, "UNKNOWN"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lnet/lingala/zip4j/exception/ZipException$Type;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lnet/lingala/zip4j/exception/ZipException$Type;->UNKNOWN:Lnet/lingala/zip4j/exception/ZipException$Type;

    filled-new-array/range {v0 .. v6}, [Lnet/lingala/zip4j/exception/ZipException$Type;
