...
.method public bind(Lnet/bytebuddy/description/field/FieldDescription$InDefinedShape;Z)Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding;
    ...
    iget-boolean p2, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->matchFieldWrite:Z
    ...
    :cond_0
    iget-boolean p2, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->matchFieldRead:Z

    if-eqz p2, :cond_1

    :goto_0
    iget-object p2, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->fieldMatcher:Lnet/bytebuddy/matcher/ElementMatcher;
    ...
    new-instance p2, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Resolved;

    .line 1629
    invoke-interface {p1}, Lnet/bytebuddy/description/field/FieldDescription$InDefinedShape;->getDeclaringType()Lnet/bytebuddy/description/type/TypeDescription;
    ...
    invoke-direct {p2, v0, p1, v1}, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Resolved;-><init>(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/description/ByteCodeElement;Lnet/bytebuddy/asm/MemberSubstitution$Substitution;)V

    goto :goto_1

    :cond_1
    sget-object p2, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Unresolved;->INSTANCE:Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Unresolved;
...
.method public bind(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/description/method/MethodDescription;Lnet/bytebuddy/asm/MemberSubstitution$Replacement$InvocationType;)Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding;
    ...
    .line 1637
    invoke-virtual {p3, v0, v1}, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$InvocationType;->matches(ZZ)Z

    move-result p3

    if-eqz p3, :cond_0

    iget-object p3, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->methodMatcher:Lnet/bytebuddy/matcher/ElementMatcher;
    ...
    new-instance p3, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Resolved;

    iget-object v0, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->substitution:Lnet/bytebuddy/asm/MemberSubstitution$Substitution;

    invoke-direct {p3, p1, p2, v0}, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Resolved;-><init>(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/description/ByteCodeElement;Lnet/bytebuddy/asm/MemberSubstitution$Substitution;)V

    goto :goto_0

    :cond_0
    sget-object p3, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Unresolved;->INSTANCE:Lnet/bytebuddy/asm/MemberSubstitution$Replacement$Binding$Unresolved;
...
.method public hashCode()I
    ...
    iget-boolean v0, p0, Lnet/bytebuddy/asm/MemberSubstitution$Replacement$ForElementMatchers;->includeSuperCalls:Z
