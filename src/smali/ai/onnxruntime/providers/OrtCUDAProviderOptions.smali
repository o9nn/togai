...
.source "OrtCUDAProviderOptions.java"
...
.method public constructor <init>(I)V
    ...
    .line 36
    new-instance v1, Lai/onnxruntime/providers/OrtCUDAProviderOptions$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lai/onnxruntime/providers/OrtCUDAProviderOptions$$ExternalSyntheticLambda0;-><init>()V

    invoke-static {v0, v1}, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->loadLibraryAndCreate(Lai/onnxruntime/OrtProvider;Lai/onnxruntime/OrtProviderOptions$OrtProviderSupplier;)J
    ...
    .line 43
    iget-object p1, p0, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->options:Ljava/util/Map;
    ...
    .line 44
    invoke-static {}, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->getApiHandle()J

    move-result-wide v1

    iget-wide v3, p0, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->nativeHandle:J

    const-string v5, "device_id"

    move-object v0, p0

    invoke-virtual/range {v0 .. v6}, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->add(JJLjava/lang/String;Ljava/lang/String;)V

    return-void

    .line 38
    :cond_0
    invoke-virtual {p0}, Lai/onnxruntime/providers/OrtCUDAProviderOptions;->close()V
