...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/media3/session/MediaNotificationManager$Api29;,
...
.method public constructor <init>(Landroidx/media3/session/MediaSessionService;Landroidx/media3/session/MediaNotification$Provider;Landroidx/media3/session/MediaNotification$ActionFactory;)V
    ...
    iput-object p1, p0, Landroidx/media3/session/MediaNotificationManager;->customLayoutMap:Ljava/util/Map;
...
.method private sendCustomCommandIfCommandIsAvailable(Landroidx/media3/session/MediaController;Ljava/lang/String;)V
    .locals 3
    ...
    .line 277
    invoke-virtual {p1, v1, v0}, Landroidx/media3/session/MediaController;->sendCustomCommand(Landroidx/media3/session/SessionCommand;Landroid/os/Bundle;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object p1

    .line 278
    new-instance v0, Landroidx/media3/session/MediaNotificationManager$1;

    invoke-direct {v0, p0, p2}, Landroidx/media3/session/MediaNotificationManager$1;-><init>(Landroidx/media3/session/MediaNotificationManager;Ljava/lang/String;)V
...
.method private startForeground(Landroidx/media3/session/MediaNotification;)V
    ...
    .line 352
    invoke-static {v0, p1}, Landroidx/media3/session/MediaNotificationManager$Api29;->startForeground(Landroidx/media3/session/MediaSessionService;Landroidx/media3/session/MediaNotification;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroidx/media3/session/MediaSessionService;->startForeground(ILandroid/app/Notification;)V
...
.method public addSession(Landroidx/media3/session/MediaSession;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/session/MediaNotificationManager;->customLayoutMap:Ljava/util/Map;
    ...
    iget-object v2, p0, Landroidx/media3/session/MediaNotificationManager;->customLayoutMap:Ljava/util/Map;

    invoke-direct {v0, v1, p1, v2}, Landroidx/media3/session/MediaNotificationManager$MediaControllerListener;-><init>(Landroidx/media3/session/MediaSessionService;Landroidx/media3/session/MediaSession;Ljava/util/Map;)V

    .line 96
    new-instance v1, Landroidx/media3/session/MediaController$Builder;
    ...
    invoke-direct {v1, v2, v3}, Landroidx/media3/session/MediaController$Builder;-><init>(Landroid/content/Context;Landroidx/media3/session/SessionToken;)V
...
.method synthetic lambda$onCustomAction$2$androidx-media3-session-MediaNotificationManager(Landroidx/media3/session/MediaController;Ljava/lang/String;)V
    .locals 0

    .line 138
    invoke-direct {p0, p1, p2}, Landroidx/media3/session/MediaNotificationManager;->sendCustomCommandIfCommandIsAvailable(Landroidx/media3/session/MediaController;Ljava/lang/String;)V
...
.method synthetic lambda$onCustomAction$3$androidx-media3-session-MediaNotificationManager(Landroidx/media3/session/MediaSession;Ljava/lang/String;Landroid/os/Bundle;Landroidx/media3/session/MediaController;)V
    ...
    .line 137
    new-instance p3, Landroidx/media3/session/MediaNotificationManager$$ExternalSyntheticLambda4;

    invoke-direct {p3, p0, p4, p2}, Landroidx/media3/session/MediaNotificationManager$$ExternalSyntheticLambda4;-><init>(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaController;Ljava/lang/String;)V
...
.method public updateNotification(Landroidx/media3/session/MediaSession;Z)V
    ...
    iget-object v1, p0, Landroidx/media3/session/MediaNotificationManager;->customLayoutMap:Ljava/util/Map;
