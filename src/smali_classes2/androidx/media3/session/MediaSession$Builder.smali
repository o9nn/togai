...
.method public build()Landroidx/media3/session/MediaSession;
    ...
    iget-object v3, p0, Landroidx/media3/session/MediaSession$Builder;->context:Landroid/content/Context;

    iget-object v4, p0, Landroidx/media3/session/MediaSession$Builder;->id:Ljava/lang/String;

    iget-object v5, p0, Landroidx/media3/session/MediaSession$Builder;->player:Landroidx/media3/common/Player;

    iget-object v6, p0, Landroidx/media3/session/MediaSession$Builder;->sessionActivity:Landroid/app/PendingIntent;

    iget-object v7, p0, Landroidx/media3/session/MediaSession$Builder;->customLayout:Lcom/google/common/collect/ImmutableList;

    iget-object v8, p0, Landroidx/media3/session/MediaSession$Builder;->callback:Landroidx/media3/session/MediaSession$Callback;

    iget-object v9, p0, Landroidx/media3/session/MediaSession$Builder;->extras:Landroid/os/Bundle;

    iget-object v1, p0, Landroidx/media3/session/MediaSession$Builder;->bitmapLoader:Landroidx/media3/common/util/BitmapLoader;
