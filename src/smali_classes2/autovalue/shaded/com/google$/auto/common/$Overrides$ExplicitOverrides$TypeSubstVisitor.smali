...
.method erasedParameterTypes(Ljavax/lang/model/element/ExecutableElement;Ljavax/lang/model/element/TypeElement;)Lautovalue/shaded/com/google$/common/collect/$ImmutableList;
    ...
    invoke-virtual {p0, v0}, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->visit(Ljavax/lang/model/type/TypeMirror;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v0}, Lautovalue/shaded/com/google$/common/collect/$ImmutableList$Builder;->add(Ljava/lang/Object;)Lautovalue/shaded/com/google$/common/collect/$ImmutableList$Builder;

    goto :goto_0

    .line 250
    :cond_0
    invoke-virtual {p2}, Lautovalue/shaded/com/google$/common/collect/$ImmutableList$Builder;->build()Lautovalue/shaded/com/google$/common/collect/$ImmutableList;
    ...
    :goto_1
    invoke-static {v3}, Lautovalue/shaded/com/google$/common/base/$Verify;->verify(Z)V
    ...
    iget-object v3, p0, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->typeBindings:Ljava/util/Map;
    ...
    .line 268
    :cond_5
    invoke-virtual {p0, p1, v1}, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->erasedParameterTypes(Ljavax/lang/model/element/ExecutableElement;Ljavax/lang/model/element/TypeElement;)Lautovalue/shaded/com/google$/common/collect/$ImmutableList;
...
.method public visitArray(Ljavax/lang/model/type/ArrayType;Ljava/lang/Void;)Ljavax/lang/model/type/TypeMirror;
    ...
    iget-object p2, p0, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->this$0:Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides;

    .line 309
    invoke-static {p2}, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides;->access$100(Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides;)Ljavax/lang/model/util/Types;
    ...
    invoke-virtual {p0, p1}, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->visit(Ljavax/lang/model/type/TypeMirror;)Ljava/lang/Object;
...
.method public visitDeclared(Ljavax/lang/model/type/DeclaredType;Ljava/lang/Void;)Ljavax/lang/model/type/TypeMirror;
    ...
    invoke-static {v1, p1}, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides;->access$200(Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides;Ljavax/lang/model/type/TypeMirror;)Ljavax/lang/model/element/TypeElement;
...
.method public visitTypeVariable(Ljavax/lang/model/type/TypeVariable;Ljava/lang/Void;)Ljavax/lang/model/type/TypeMirror;
    ...
    iget-object v0, p0, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->typeBindings:Ljava/util/Map;
    ...
    iget-object p1, p0, Lautovalue/shaded/com/google$/auto/common/$Overrides$ExplicitOverrides$TypeSubstVisitor;->typeBindings:Ljava/util/Map;
