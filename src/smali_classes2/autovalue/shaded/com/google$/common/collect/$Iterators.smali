...
.method public static concat(Ljava/util/Iterator;Ljava/util/Iterator;)Ljava/util/Iterator;
    ...
    invoke-static {p0}, Lautovalue/shaded/com/google$/common/collect/$Iterators;->concat(Ljava/util/Iterator;)Ljava/util/Iterator;
...
.method public static varargs concat([Ljava/util/Iterator;)Ljava/util/Iterator;
    ...
    invoke-static {p0}, Lautovalue/shaded/com/google$/common/collect/$Iterators;->concatNoDefensiveCopy([Ljava/util/Iterator;)Ljava/util/Iterator;
...
.method public static varargs cycle([Ljava/lang/Object;)Ljava/util/Iterator;
    ...
    invoke-static {p0}, Lautovalue/shaded/com/google$/common/collect/$Iterators;->cycle(Ljava/lang/Iterable;)Ljava/util/Iterator;
...
.method public static filter(Ljava/util/Iterator;Ljava/lang/Class;)Lautovalue/shaded/com/google$/common/collect/$UnmodifiableIterator;
    ...
    invoke-static {p0, p1}, Lautovalue/shaded/com/google$/common/collect/$Iterators;->filter(Ljava/util/Iterator;Lautovalue/shaded/com/google$/common/base/$Predicate;)Lautovalue/shaded/com/google$/common/collect/$UnmodifiableIterator;
...
.method static forArray([Ljava/lang/Object;III)Lautovalue/shaded/com/google$/common/collect/$UnmodifiableListIterator;
    ...
    .line 1022
    :cond_1
    new-instance v0, Lautovalue/shaded/com/google$/common/collect/$Iterators$ArrayItr;

    invoke-direct {v0, p0, p1, p2, p3}, Lautovalue/shaded/com/google$/common/collect/$Iterators$ArrayItr;-><init>([Ljava/lang/Object;III)V
...
.method public static peekingIterator(Lautovalue/shaded/com/google$/common/collect/$PeekingIterator;)Lautovalue/shaded/com/google$/common/collect/$PeekingIterator;
    ...
    check-cast p0, Lautovalue/shaded/com/google$/common/collect/$PeekingIterator;
...
.method public static peekingIterator(Ljava/util/Iterator;)Lautovalue/shaded/com/google$/common/collect/$PeekingIterator;
    ...
    .line 1198
    check-cast p0, Lautovalue/shaded/com/google$/common/collect/$Iterators$PeekingImpl;
...
.method public static toArray(Ljava/util/Iterator;Ljava/lang/Class;)[Ljava/lang/Object;
    ...
    .line 341
    invoke-static {p0, p1}, Lautovalue/shaded/com/google$/common/collect/$Iterables;->toArray(Ljava/lang/Iterable;Ljava/lang/Class;)[Ljava/lang/Object;
...
.method public static unmodifiableIterator(Lautovalue/shaded/com/google$/common/collect/$UnmodifiableIterator;)Lautovalue/shaded/com/google$/common/collect/$UnmodifiableIterator;
    ...
    check-cast p0, Lautovalue/shaded/com/google$/common/collect/$UnmodifiableIterator;
